// Ported from the old app's src/lib/exportSchedule.js - pure client-side PDF
// export, no backend dependency, unchanged logic.
...
function rankOf(staffId: string, staffData: Staff[]) {
